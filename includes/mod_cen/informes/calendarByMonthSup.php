...
<!-- <div class="form-group"> -->
  <form class="form-inline" action="index.php?mod=slat&men=informe&id=29&ref=<?php echo $_GET['ref']?>" method="post" align="center">
    <div class="form-group">
...
if(isset($_GET["ref"])){
	switch ($_GET["ref"]) {
		case 'etj':
			...
			$buscar_ref=$ref->buscarRef(null,null,$_SESSION['referenteId']);
			break;
		case 'coordinador':
				$ref= new Referente(null,null,null,null,null,null,null,"Activo");
...
?>
	...
	while ($registro = mysqli_fetch_object($buscar_ref)) {
		...
		$escuelas=new EscuelaReferentes(null,null,'33',$registro->referenteId); // buscamos las escuelas del ETT
  ...
  $lista2= array(); //array para guardar num de escuelas calendario
    ...
    $lista2[$indice]=$escuelaResultado->numero;
	    ...
	    if($escuelaInformeActual <> $fila->escuelaId){
	    		...
	    		$escuelaEtt = new EscuelaReferentes(null,$fila->escuelaId,'33');  // buscamos a quien le pertenece la escuela
