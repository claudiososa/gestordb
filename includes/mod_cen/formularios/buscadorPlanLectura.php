<form class="form-horizontal" action="index.php?mod=slat&men=escuelas&id=32" method='POST'>
  <div class="form-group">
    <label class="col-md-3 col-md-offset-2"><h3>Busqueda de Escuelas Plan de Lectura</h3></label>
  </div>
  <div class="form-group">
