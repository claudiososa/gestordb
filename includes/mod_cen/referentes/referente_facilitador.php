...
echo '<div class="container">'; 
	...
	while ($fila = mysqli_fetch_object($resultado))
	{
		...
		$escuela= new FacilEscuelas(null,null,$fila->referenteId);
		...
		echo "<td>"."<a href='index.php?mod=slat&men=user&id=19&referenteId=".$fila->referenteId."'>Escuelas <b>(".$cantidad_escuela.")</b></a></td>";
		...
		echo "<td>".$fila->telefonoM."/".$fila->telefonoC."</td>";
