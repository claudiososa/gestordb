...
$escuela= new Escuela(null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,$referenteId);
...
while ($fila = mysqli_fetch_object($resultado))
{
	...
	$buscar_informe = $informe->buscarSupervisorSuperior();
	...
	if($cant==0){
		...
		echo "<td><a class='btn btn-danger' href='index.php?mod=slat&men=informe&id=1&tipo=supervisor-secundaria&escuelaId=".$fila->escuelaId."'>
	 	...
	 	echo "<td><a class='btn btn-success' href='index.php?mod=slat&men=informe&id=1&escuelaId=".$fila->escuelaId."'>
					 Crear</a></td>";
		echo  "<td><a class='btn btn-success' href='index.php?mod=slat&men=informe&tipo=supervisor-nivel-superior&id=2&escuelaId=".$fila->escuelaId."'>$cant</a></td>";
	}
