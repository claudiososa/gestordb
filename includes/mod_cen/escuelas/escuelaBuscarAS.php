...
if(($_POST))
	{
				...
				$resultado = $escuela->buscarAs();
				$resultado2= $escuela->buscarAs();
	...
	// ====== Datos de Predio[FIN] ======== //
           ...
           echo '<div class="col-md-12">';
					 echo '<div class="alert alert-success" role="alert">Datos de Nacion</div>';

					 echo"<div><b>Adicionales</b></div>";
					 echo "<div>$fila->as_nombre <br>$fila->as_ambito<br>$fila->as_domicilio<br>Telefono: $fila->as_telefono<br>Localidad:$fila->as_localidad<br>Departamento:$fila->as_departamento
                  <br>Coordenadas:$fila->as_longitud,$fila->as_latitud<br>Electricidad:$fila->as_electricidad<br>Mas detalles:$fila->as_universo

           </div>";
					 echo "<br></div>";
           echo '<div class="col-md-12">';
          echo '<div class="alert alert-success" role="alert">Datos de Piso Tecnologico</div>';

          echo"<div><b>Dato Piso Tecnologico</b></div>";
          echo "<div>Tiene Servidor: $fila->servidor <br>Serie:$fila->servidor_serie<br>Marca:$fila->servidor_marca<br>
          Tipo: $fila->servidor_tipo<br>Estado de Funcionamiento:$fila->servidor_funciona<br>Internet:$fila->internet<br>Tipo de Conexion $fila->internet_tipo
          <br>Piso Observaciones:$fila->observacion
           </div>";
          echo "<br></div>";
