...
$resultado = $escuela->Cargo('Facilitador');
...
while ($fila = mysqli_fetch_object($resultado))
{
	...
	echo "<td>";
		...
		$informe = new Informe(null,$fila->escuelaId,$_GET['referenteId']);
		...
		echo "<td><a href='index.php?mod=slat&men=informe&id=1&escuelaId=".$fila->escuelaId."'>
			 Crear</a>&nbsp&nbsp<a href='index.php?mod=slat&men=informe&id=22&referenteId=".$_GET[referenteId]."&escuelaId=".$fila->escuelaId."'>Ver&nbsp(".$cant.")</a></td>";
