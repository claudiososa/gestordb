...
<div class="row hidden-xs">
	...
	<div class="col-lg-2 col-md-4 col-sm-4">
		<a href="" style="text-decoration:none"><img class="img-responsive"src="includes/mod_cen/portada/imgPortadas/equipo (3).png"><h3 align="center">Mis Supervisores</h3></a>
	</div>
