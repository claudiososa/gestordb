$(document).ready(function() {
  ...
  $('[id ^=normal]').on('click', function(){
    ett=$(this).parent().parent().attr('id').substr(3)


    prioridad=$(this).attr('id').substr(0,6)
    //alert(prioridad)
    ...
    if (typeof(existe)==='undefined') {
        ...
        $.ajax({
          ...
          type: 'POST',
          dataType: 'json',
          data: {myReport:myReport,referenteId:ett,prioridad:prioridad}
        })
        .done(function(lista) {
