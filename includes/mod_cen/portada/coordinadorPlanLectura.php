...
$resultado_referente_acargo = $referente->Cargo("Activo");


$referente_ett= new Referente(null,null,"ETTPL"); // ETTPL = ett plan de lectura
$buscar_ett=$referente_ett->Tipo("ETTPL","Activo"); 

// todos los informes creados por referente Plan de lectura
$arrayPlanLectura = array ('ETTPL',
									'CPPL'
									);      // CPPL = Coordinador Provincial del Plan de Lectura
$informeEquipoLectura = $informes->buscar(20,null,$arrayPlanLectura);

//busqueda de informes de proiridad alta
$informe_alta= new Informe(null,null,null,"Alta");
$buscar_alta =$informe_alta->buscar(20,null,$arrayPlanLectura);
$total = mysqli_num_rows($buscar_alta);

//busqueda de informes de proiridad media
$informe_media= new Informe(null,null,null,"Media");
$buscar_media =$informe_media->buscar(20,null,$arrayPlanLectura);
...
$buscar_normal =$informe_normal->buscar(20,null,$arrayPlanLectura);
...
if(mysqli_num_rows($resultado_referente_acargo)>0){
  ?>
<?php
}
echo "</div>";
...
<div class="panel panel-primary">
  <div class="panel-heading" id="panel4"><span class="panel-title clickable">
    <h4>Ultimos informes creados por Equipo Plan de Lectura<span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-down"></i></span></h4></span>
  </div>
  <div class="panel-body">
    <?php
...
while ($fila=mysqli_fetch_object($informeEquipoLectura)){
...
<div class="panel-body">
  ...
  while ($fila=mysqli_fetch_object($resultado_referente_acargo)){
    echo "<tr>";
