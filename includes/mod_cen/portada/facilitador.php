...
$listadeReferentes= array("Facilitador","CoordinadorFacilitador");
...
if(mysqli_num_rows($b_informe)>0){
	...
	<div class="panel panel-primary">
		<div class="panel-heading" id="panel2"><span class="panel-title clickable">
			<h4>Ultimos informes  Escuelas del Futuro<span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-down"></i></span></h4></span>
		</div>
		<div class="panel-body">
			<?php
