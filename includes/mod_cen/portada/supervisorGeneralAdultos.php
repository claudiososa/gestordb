...
$referente= new Referente(128);
$resultado_referente_acargo = $referente->Cargo("Activo");

$referente_ett= new Referente(null,null,"SupervisorAdultos");
$buscar_ett=$referente_ett->Tipo("SupervisorAdultos","Activo");

// todos los informes creados por referente PMI
$arrayAdultos = array ('SupervisorAdultos',
                   'SupervisorGeneralAdultos',
									'DirectorNivelAdultos'
									);
$informeEquipoPmi = $informes->buscar(20,null,$arrayAdultos);

//busqueda de informes de proiridad alta
$informe_alta= new Informe(null,null,null,"Alta");
$buscar_alta =$informe_alta->buscar(20,null,$arrayAdultos);
$total = mysqli_num_rows($buscar_alta);

//busqueda de informes de proiridad media
$informe_media= new Informe(null,null,null,"Media");
$buscar_media =$informe_media->buscar(20,null,$arrayAdultos);
...
$buscar_normal =$informe_normal->buscar(20,null,$arrayAdultos);
...
<div class="panel panel-primary">
  <div class="panel-heading" id="panel4"><span class="panel-title clickable">
    <h4>Ultimos informes creados por Equipo Supervisores Adultos<span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-down"></i></span></h4></span>
  </div>
  <div class="panel-body">
    <?php
...
while ($fila=mysqli_fetch_object($informeEquipoPmi)){
