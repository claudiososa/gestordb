...
if(trim($_POST['txtidpersona'])!=""){//Si existe la persona en la base
	...
	else//Existe Autoridad para la escuela
	{
		...
		$modificardirector="UPDATE directores SET personaId='".$_POST['txtidpersona']."',
																							tipoautoridad_id='".$_POST['cbtipoautoridad']."' WHERE directorId =".$_POST['iddirector'];
	...
	$sentencia="UPDATE personas SET apellido ='".strtoupper($_POST['txtapellido'])."',
																	...
																	cpostal = '".$_POST['txtcp']."' WHERE personaId =".$_POST['txtidpersona'];
