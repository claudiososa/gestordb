<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="index.php?mod=slat&men=admin&id=26&tipo=33">Asignar Escuelas</a></li>
        ...
        <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                    <li><a href="index.php?mod=slat&men=informe&id=29&ref=etj">Visitas de Supervisores mensuales</a></li>                    
              </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
                ...
                <li ><a href="index.php?mod=slat&men=escuelas&id=39">Buscar carreras en escuelas</a></li>                
          </ul>
        </li>
        <li class="dropdown">
