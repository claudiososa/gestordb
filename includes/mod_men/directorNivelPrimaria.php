<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="index.php?mod=slat&men=user&id=8">Mis Supervisores <span class="sr-only">(current)</span></a></li>
        <li class="dropdown">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
                <li ><a href="index.php?mod=slat&men=admin&id=14">Sobre Supervisores</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
                ...
                <li ><a href="index.php?mod=slat&men=escuelas&id=18">Escuelas</a></li>
                 <li ><a href="index.php?mod=slat&men=user&id=7">Todos los supervisores</a></li>
